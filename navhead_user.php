                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
								...
								<br>
                                    ...
                                    <!--- login button -->
                                  <?php
                                    $student_query=mysql_query("select * from tbl_teacher where teacher_id='$session_id'")or die(mysql_error());
                                    $teacher_row=  mysql_fetch_array($student_query);
                                    ?>

                                     <img  src="admin/<?php echo $teacher_row['image']; ?>"  class="img img-rounded" id="picture">
                                        &nbsp;
                                    <div class="btn-group">
