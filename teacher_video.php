                            ...
                            while ($row = mysql_fetch_array($query)) {
                                ...
                                ?>
									...
									<a  rel="tooltip"  title="Delete" id="d<?php echo $row['subject_id']; ?>" href="delete_teacher_subject.php<?php echo '?id=' .  $row['subject_id']; ?>" role="button"  data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;</a>
									 ...
									 <td>
									 <a  rel="tooltip"  title="upload files" id="d<?php echo $row['subject_id']; ?>" href="video_upload.php<?php echo '?id=' .  $row['subject_id']; ?>" role="button"  data-toggle="modal" class="btn btn-info"><i class="icon-plus-sign-alt icon-large"></i>&nbsp; Upload Files</a>
